...
def output_dir():
    ...
    path = shared.opts.data.get("hakuimg_saving_path", "outputs/hakuimg")
    ...
    try:
        if system_name == "Windows":
            ...
            print(f"Directory Opening a folder is not supported on this OS: {system_name}")
...
def add_tab():
    ...
    with gr.Blocks(analytics_enabled=False) as demo:
        with FormRow(equal_height=False):
            ...
            with gr.Column():
                ...
                with gr.Row():
                    ...
                    output_dir_btn = gr.Button("output directory", elem_id="output_dir")
                with gr.Row():
        ...
        # output_dir
        output_dir_btn.click(output_dir)
